...
const dateStringCustom = createCustomMapper(
  (params) => {
...
const dateStringYearMinMax = createMinMaxMapper(
  "date_string_year",
  (issue) => {
...
const passwordCustom = createCustomMapper(
  (params) => {
...
const json = (message = DEFAULT_MESSAGE) => {
  const schema = zod.z.lazy(
    () => zod.z.union([literal, zod.z.array(schema), zod.z.record(schema)], {
